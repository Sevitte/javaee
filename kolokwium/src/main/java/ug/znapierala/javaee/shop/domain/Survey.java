...
public class Survey {
    ...
    private String frequency = "Codziennie";
    ...
    public String toString() {
        ...
        return "Data zamowienia (od): " + df.format(usedFrom) + "<br>" +
                "Data zgloszenia (do): " + df.format(usedTo) + "<br>" +
                "Czestotliwosc uzytkowania: " + frequency + "<br>" +
                "Uwagi:<br>" + comments;
    }
