  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (application) {
        ...
        if (storage == null){
          try {
            storage = (com.example.servletjspdemo.service.StorageService) java.beans.Beans.instantiate(this.getClass().getClassLoader(), "com.example.servletjspdemo.service.StorageService");
          } catch (ClassNotFoundException exc) {
            throw new InstantiationException(exc.getMessage());
          } catch (Exception exc) {
            throw new ServletException("Cannot create bean of class " + "com.example.servletjspdemo.service.StorageService", exc);
          }
      ...
      synchronized (session) {
        ...
        if (person == null){
          try {
            person = (com.example.servletjspdemo.domain.Person) java.beans.Beans.instantiate(this.getClass().getClassLoader(), "com.example.servletjspdemo.domain.Person");
          } catch (ClassNotFoundException exc) {
            throw new InstantiationException(exc.getMessage());
          } catch (Exception exc) {
            throw new ServletException("Cannot create bean of class " + "com.example.servletjspdemo.domain.Person", exc);
          }
