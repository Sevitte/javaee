<%@ page import="ug.znapierala.javaee.shop.domain.Survey" %>
...
<body>
<jsp:useBean id="surveyStorage" class="ug.znapierala.javaee.shop.service.SurveyService" scope="application" />
